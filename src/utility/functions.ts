...
import { CellClassObjectType, TableClassObjectType, SheetClassObjectType} from "./Classes";
   ...
   */
  export const cloneAndSetTableCell = (x: number, y: number, tableIndex: number, dispatch: Function, sheet: SheetClassObjectType, callback: (cl: CellClassObjectType) => void ) => {
   ...
   */
  export const getEvaluatedText = (text: string, tableIndex: number, sheet: SheetClassObjectType) => {
